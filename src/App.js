...
function App() {
  ...
  const [resStyle, setResStyle] = useState({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"});

  const setArtist = (artist) => {
    console.log("setting artist to: " + artist)
    if(artist === 'Kanye') { setBackground('kanye_west');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${KanyeWest})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am Kanye West. Ask me a question.'); setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"}) }
    else if(artist === 'Snoop') { setBackground('snoop_dogg');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${SnoopDogg})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am Snoop Doggy Dogg, wuz poppin cuz?'); setResStyle({position:"fixed",left:"8%",top:"45%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"}) }
    else if(artist === 'Travis') { setBackground('travis_scott');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${TravBubble})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am Travis Scott. Ask me a question.'); setResStyle({position:"fixed",left:"38%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"}) }
    else if(artist === 'Nicki') { setBackground('nicki_minaj');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${NickiMinaj})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am Nicki Minaj. Ask me a question.'); setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"})}
    else if(artist === 'Steve') { setBackground('steve_from_minecraft');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Steve})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am Steve from Minecraft. Ask me a question.'); setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"})}
    else if(artist === 'Mario') { setBackground('mario');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Mario})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am Mario. Ask me a question.'); setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"})}
    else if(artist === 'Green') { setBackground('green_guy');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Green})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am the Green Guy. Ask me a question.'); setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"})}
    else if(artist === 'Shadow') { setBackground('shadow');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Shadow})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am Shadow. Ask me a question.') ; setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"})}
    else if(artist === 'God') { setBackground('god');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${God})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am God. Ask me a question.'); setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"})}
    else if(artist === 'Fortune') { setBackground('fortune_teller');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Fortune})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}); setResponse('Hello, I am the Fortune Teller. Ask me a question.'); setResStyle({position:"fixed",left:"8%",top:"25%", fontSize:"15px",zIndex:"99",width:"40%",background:"white",border:"5px solid gray",borderRadius:"10%",padding:"15px"})}
  }
