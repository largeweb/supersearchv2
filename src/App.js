...
function App() {
  ...
  const [travResponse, setTravResponse] = useState('');
  ...
  const setArtist = (artist) => {
    ...
    if(artist === 'Kanye') { setBackground('kanye_west');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${KanyeWest})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Snoop') { setBackground('snoope_dogg');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${SnoopDogg})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Travis') { setBackground('travis_scott');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${TravBubble})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Nicki') { setBackground('nicki_minaj');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${NickiMinaj})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Steve') { setBackground('steve_from_minecraft');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Steve})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Mario') { setBackground('mario');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Mario})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Green') { setBackground('green_guy');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Green})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Shadow') { setBackground('shadow');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Shadow})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'God') { setBackground('god');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${God})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
    else if(artist === 'Fortune') { setBackground('fortune_teller');setStyle({left:"0",right:"0",top:"0",bottom:"0",position:"fixed",backgroundSize:"cover",backgroundImage:`url(${Fortune})`,backgroundPosition:"center",backgroundRepeat:"no-repeat",zIndex:"-1"}) }
  }
  ...
  const ask = async() => {
    ...
    setTravResponse(data.choices[0].text)
  }
  ...
  return (
    <div className="App">
      ...
      <div style={{position:"fixed",left:"5%",top:"25%",height:"50%", fontSize:"25px",zIndex:"99",width:"40%"}}>{travResponse}</div>
    </div>
  );
}
